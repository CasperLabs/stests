...
alias stests-stack-view-vars=$STESTS_PATH_SH/stack/view_vars.sh
...
alias stests-cache-set-network-faucet-key='_exec_cmd $STESTS_PATH_SH_SCRIPTS/cache_set_network_faucet_key.py'
...
alias stests-cache-set-node-bonding-key='_exec_cmd $STESTS_PATH_SH_SCRIPTS/cache_set_node_bonding_key.py'
